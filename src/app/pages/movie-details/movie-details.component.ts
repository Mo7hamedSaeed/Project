...
export class MovieDetailsComponent implements OnInit{
  ...
  getMovie(id:any){
    this.myMoviesService.getMovieById(id).subscribe(async(result)=>{
  ...
  getVideo(id:any)
  {
    this.myMoviesService.getMovieVideo(id).subscribe((result)=>{
  ...
  getMovieCast(id:any)
  {
    this.myMoviesService.getMovieCast(id).subscribe((result)=>{
  ...
  {
    this.myMoviesService.getDirectorForMovie(id).subscribe((result)=>{
  ...
  {
    this.myMoviesService.getWriterForMovie(id).subscribe((result)=>{
  ...
  {
    this.myMoviesService.getMovieSimilar(id).subscribe((result)=>{
